	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#topicAdmin"><i class="fa fa-comment"></i>
						Topics</a></li>
				<li><a href="#contentAdmin"><i class="fa fa-comment"></i>
						Contents</a></li>
				<li><a href="#contactUsMessage"><i class="fa fa-comment"></i>
						Contact Us Message's</a></li>
			</ul>
		</div>
	</nav>
