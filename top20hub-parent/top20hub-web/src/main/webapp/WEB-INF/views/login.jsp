...
<body onload='document.f.username.focus();'>
	...
	<!-- Form login -->
	<!-- <form name='f' action='/top20hub-web/login' method='POST'>
		<p class="h5 text-center mb-4">Sign in</p>

		<div class="md-form">
			<i class="fa fa-envelope prefix grey-text"></i> <input type="text"
				id="defaultForm-email" class="form-control" name='username' value=''>
			<label for="defaultForm-email">Your email</label>
		</div>

		<div class="md-form">
			<i class="fa fa-lock prefix grey-text"></i> <input type="password"
				id="defaultForm-pass" class="form-control" name='password'>
            ...
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                       ...
                       <!--  <form id="loginform" class="form-horizontal" role="form"> -->
                        <form id="loginform" class="form-horizontal" role="form" name='f' action='/top20hub-web/login' method='POST'>
