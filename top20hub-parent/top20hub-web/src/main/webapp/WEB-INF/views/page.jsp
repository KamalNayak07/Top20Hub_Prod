	...
	<script>
		...
		$(function() {
			$('.first-button').on(
					'click',
					function() {
						$('.interest-content').animate(
								{
									height : "toggle"
								},
								function() {
									$('.content-lifestyle').animate({
										height : "toggle"
									});
									var h = $(
											".modal-body .content-lifestyle p")
											.height();
									$(".modal-body").css('height',
											h + 550 + 'px');
									$(".modal-body .content-lifestyle p").css(
											'height', h + 'px');
								});
					});
			$('.second-button')
