                        ...
                        <div class="card card-body pb-0">
                            ...
                            <div class="single-post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="post-data">
                                            <p class="font-small grey-text mb-0"><i class="fa fa-clock-o"></i> 15/09/2017</p>
                                        </div>
                            ...
                            <div class="single-post mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="view overlay">
                                            <img src="http://mdbootstrap.com/img/Photos/Horizontal/People/4-col/img%20(85).jpg" class="img-fluid rounded-0" alt="sample image">
                                            <a>
                                                <div class="mask rgba-white-slight"></div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="post-data">
                                            <p class="font-small grey-text mb-0"><i class="fa fa-clock-o"></i> 21/08/2018</p>
                                        </div>
                                    </div>
                                    <!--/ Excerpt -->
                                </div>
